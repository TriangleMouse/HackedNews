...
namespace HackedNews.Data
{
    ...
    {
        private static int GetCategoryId(string CategoryName, AppDBContext context) => context.Category.FirstOrDefault(p => p.Name == CategoryName).Id;
            ...
            if (!context.News.Any())
            {
                context.News.AddRange(
                    new News {
                        ...
                        Img_Link= "https://cdnn21.img.ria.ru/images/07e5/0a/06/1753387486_0:0:3106:2047_1440x900_80_1_1_373f14d7dd32e06c2779f98ff9e022f5.jpg.webp?source-sid=rian_photo",
                        Switch_Load_Img = false,
                        Img_Load = null,
                        AuthorNews ="Риа Новости",
                        CategoryID= GetCategoryId("Политика", context),
                        ShorttextCard= "Читатели китайского издания \"Гуаньча\" положительно оценили слова главы российского МИД Сергея Лаврова, заявившего...",
                        Date = DateTime.Now.ToString(),
                        ListNewsDatas =new List<NewsData>
                        {
                            new NewsData{ 
                                Subtitle=@"Читатели ""Гуанча"": слова Лаврова о принадлежности Тайваня к КНР свидетельствуют о дружбе",
                                Img_Link=null,
                                Switch_Load_Img=false,
                                Img_Load=null,
                                Txt="МОСКВА, 14 окт — РИА Новости. Читатели китайского издания \"Гуаньча\" положительно оценили слова главы российского МИД Сергея Лаврова, заявившего, что Россия, как и подавляющее большинство стран мира," +
                    ...
                    new News
                    {
                        ...
                        Img_Link = "https://gagadget.com/media/cache/0b/db/0bdb67ffa987ff2abf72f173369555e7.jpg",
                        Switch_Load_Img = false,
                        Img_Load = null,
                        AuthorNews = "HackedNews",
                        CategoryID = GetCategoryId("Наука", context),
                        ShorttextCard = "Если вам понадобился видеорегистратор, то проще всего будет купить его на Aliexpres...",
                        Date = DateTime.Now.ToString(),
                        ListNewsDatas = new List<NewsData>
                        {
                            new NewsData{
                                Subtitle=@"Видеорегистратор 70MAI Dash Cam 4k A800S",
                                Img_Link="https://gagadget.com/media/cache/c9/10/c9100874fb49e01ce0b9b9e9548f3728.jpg",
                                Switch_Load_Img=false,
                                Img_Load=null,
                                Txt="Компания Xiaomi вместе с брендом 70MAI выпустила новый видеорегистратор A800S, который можно назвать флагманом во всей линейке." +
                            ...
                            new NewsData{
                                ...
                                Img_Link="https://gagadget.com/media/uploads/%D0%92%D0%B8%D0%B4%D0%B5%D0%BE%D1%80%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%2070MAI%20A500S%20Pro%20Plus.jpg",
                                Switch_Load_Img=false,
                                Img_Load=null,
                                Txt="Перечислять характеристике уже нет смысла, так как они сильно совпадают с предыдущими, можно выделить только одну вещь: запись будет в 2592x1944, что означает режим 4:3 (это не очень хорошо)." +
                            ...
                            new NewsData{
                                ...
                                Img_Link="https://gagadget.com/media/uploads/%D0%92%D0%B8%D0%B4%D0%B5%D0%BE%D1%80%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%82%D0%BE%D1%80%20VVCAR%20D530.jpg",
                                Switch_Load_Img=false,
                                Img_Load=null,
                                Txt="Характеристики этого гаджета можно назвать лучшими в нашем топе: 4К запись у основной камеры, у задней 1920x1080." +
                    ...
                    new News
                    {
                        ...
                        NewsIntroduction= "Компания Samsung уже приступила к тестированию фирменной оболочки One UI 4.0. Бета-версия программного обеспечения доступна для флагманских смартфонов Galaxy S21, а стабильную сборку придётся ждать до зимы.",
                        Img_Link = "https://gagadget.com/media/cache/40/af/40af5a68db3ea30dafc0751c3e7402b8.jpg",
                        Switch_Load_Img = false,
                        Img_Load = null,
                        AuthorNews = "HackedNews",
                        CategoryID = GetCategoryId("Наука", context),
                        Date = DateTime.Now.ToString(),
                        ShorttextCard = "Компания Samsung уже приступила к тестированию фирменной оболочки One UI 4.0. Бета-версия...",
                        ListNewsDatas = new List<NewsData>
                        {
                            new NewsData{
                    ...
                    new News
                    {
                        ...
                        Img_Link = "https://ichef.bbci.co.uk/news/800/cpsprodpb/3B02/production/_121060151_gettyimages-1235719365.jpg",
                        Switch_Load_Img = false,
                        Img_Load = null,
                        AuthorNews = "BBC",
                        CategoryID = GetCategoryId("Политика", context),
                        Date=DateTime.Now.ToString(),
                        ShorttextCard = "Лидеры самых развитых экономик мира во вторник встретились на внеочередном виртуальном саммите, чтобы решить...",
                        ListNewsDatas = new List<NewsData>
                        {
                            new NewsData{
                                ...
                                Switch_Load_Img=false,
                                Img_Load=null,
                                Txt="Лидеры самых развитых экономик мира во вторник встретились на внеочередном виртуальном саммите, чтобы решить, как оказать помощь Афганистану, который стремительно близится к экономической и гуманитарной катастрофе.",
                            }
                        }
                    }
        ...
        public static Dictionary<string,Category> Categories
        {
            get
            {
                if (category == null)
                {
                    ...
                    {
                        new Category{ Name="Культура", Desc="Читайте свежие новости культуры: о новинках кино, культурных событиях в регионах, фестивалях и литературных премиях..."},
                        new Category{ Name="Наука", Desc="Актуальные новости научных открытий, высоких технологий, электроники и космоса... "},
                        new Category{ Name="Политика", Desc="Актуальные новости о политике, политических преступлениях..."},
                        new Category{ Name="Спорт", Desc="Последние новости спорта, самые свежие событии..."},
                        new Category{ Name="Экономика", Desc="Самые актуальные новости об экономики во всех странах мир..." },
